  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover and engage with our vibrant fitness community, share your thoughts and connect with fellow enthusiasts."
        />
      </Helmet>
      <section className="py-12  text-white min-h-screen">
        <div className="">
          ...
          >
            <Typography
              variant="h2"
              className="text-4xl font-bold bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent mb-4"
            >
              Forum Discussions
            </Typography>
            <Typography className="text-gray-300 max-w-2xl mx-auto">
              Share your thoughts and engage with our vibrant community. Join
              the conversation and connect with fellow fitness enthusiasts.
            </Typography>
          </motion.div>
              ...
              {posts.length > 0 ? (
                ...
                <>
                  ...
                  >
                    ...
                    <Typography className="text-xl text-gray-300">
